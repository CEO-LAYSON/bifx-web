...
const UserManagementTable = () => {
  ...
  return (
    <div className="relative group">
      {/* Glow Effect */}
      <div className="absolute -inset-0.5 bg-gradient-to-r from-primary-purple/30 via-primary-gold/20 to-primary-purple/30 rounded-2xl blur opacity-40 group-hover:opacity-30 transition-opacity duration-500" />
