  ...
  return (
    <div className="w-full max-w-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="relative">
          <div className="flex justify-between items-center mb-2">
            ...
            <Link
              to="/forgot-password"
              className="text-sm text-primary-purple hover:text-purple-400 transition-colors"
            >
              Forgot password?
            </Link>
          </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button className="flex items-center justify-center gap-2 px-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl hover:bg-gray-800 transition-all duration-200 group">
