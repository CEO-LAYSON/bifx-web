  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:flex lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:w-1/2 relative overflow-hidden z-0">
        ...
        {/* Content - Scaled */}
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-8 text-white lg:scale-90 lg:origin-top">
          {/* Logo */}
          <div className="mb-6">
            <img
          ...
          {/* Brand Text */}
          <h1 className="text-4xl font-bold mb-3 text-center">BIFX</h1>
